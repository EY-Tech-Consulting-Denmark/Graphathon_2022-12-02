...
If you will get stup, look up the exercise in the [Algorithms_answers.md]().  

6. Eventually you can try to improve a machine learning model by enriching it with the graph features. We have prepared a [MachineLearning.ipynb]() for you, you can build up upon.  
